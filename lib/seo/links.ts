...
export const LINK_REGISTRY: Readonly<Record<string, readonly string[]>> = {
  ...
  [MODULE_PATHS.incidents]: ['/platform', MODULE_PATHS.riddor, MODULE_PATHS.risk, MODULE_PATHS.permits, MODULE_PATHS.investigations, MODULE_PATHS.actions, MODULE_PATHS.dashboards, '/platform/offline', ARTICLES.nearMiss, ARTICLES.investigate, '/toolkit', TOOL_PATHS.afr, '/industries/facilities-management', '/industries/field-services', '/industries/transport-logistics', '/demo'],
  [MODULE_PATHS.riddor]: ['/platform', MODULE_PATHS.incidents, MODULE_PATHS.risk, MODULE_PATHS.permits, MODULE_PATHS.investigations, MODULE_PATHS.dashboards, ARTICLES.riddorExplained, ARTICLES.accidentBook, TOOL_PATHS.riddor, TOOL_PATHS.afr, '/industries/transport-logistics', '/industries/construction', '/industries/healthcare', '/industries/window-door-fitters', '/demo'],
  [MODULE_PATHS.risk]: ['/platform', MODULE_PATHS.permits, MODULE_PATHS.incidents, MODULE_PATHS.riddor, MODULE_PATHS.bowtie, MODULE_PATHS.actions, MODULE_PATHS.documents, ARTICLES.loneWorker, TOOL_PATHS.matrix, '/industries/manufacturing-warehousing', '/industries/construction', '/industries/window-door-fitters', '/demo'],
  [MODULE_PATHS.permits]: ['/platform', MODULE_PATHS.risk, MODULE_PATHS.incidents, MODULE_PATHS.riddor, MODULE_PATHS.training, MODULE_PATHS.documents, MODULE_PATHS.contractors, ARTICLES.rams, '/industries/construction', '/industries/facilities-management', '/industries/manufacturing-warehousing', '/demo'],
  ...
  [MODULE_PATHS.investigations]: ['/platform', MODULE_PATHS.incidents, MODULE_PATHS.actions, MODULE_PATHS.riddor, MODULE_PATHS.risk, ARTICLES.investigate, '/industries/transport-logistics', '/industries/construction', '/industries/manufacturing-warehousing', '/demo'],
  [MODULE_PATHS.actions]: ['/platform', MODULE_PATHS.investigations, MODULE_PATHS.risk, MODULE_PATHS.bowtie, MODULE_PATHS.permits, MODULE_PATHS.fleet, MODULE_PATHS.training, MODULE_PATHS.dashboards, MODULE_PATHS.checklists, MODULE_PATHS.contractors, '/industries/facilities-management', '/industries/manufacturing-warehousing', '/industries/construction', '/demo'],
  [MODULE_PATHS.fleet]: ['/platform', MODULE_PATHS.actions, MODULE_PATHS.incidents, MODULE_PATHS.training, MODULE_PATHS.dashboards, MODULE_PATHS.checklists, TOOL_PATHS.afr, '/industries/transport-logistics', '/industries/manufacturing-warehousing', '/industries/field-services', '/industries/window-door-fitters', '/demo'],
  [MODULE_PATHS.training]: ['/platform', MODULE_PATHS.actions, MODULE_PATHS.permits, MODULE_PATHS.bowtie, MODULE_PATHS.fleet, MODULE_PATHS.documents, MODULE_PATHS.checklists, '/industries/healthcare', '/industries/construction', '/industries/transport-logistics', '/demo'],
  [MODULE_PATHS.documents]: ['/platform', MODULE_PATHS.risk, MODULE_PATHS.training, MODULE_PATHS.permits, MODULE_PATHS.bowtie, ARTICLES.rams, '/platform/offline', '/industries/facilities-management', '/industries/field-services', '/industries/healthcare', '/demo'],
  ...
  [MODULE_PATHS.bowtie]: ['/platform', MODULE_PATHS.risk, MODULE_PATHS.actions, MODULE_PATHS.permits, MODULE_PATHS.training, MODULE_PATHS.documents, TOOL_PATHS.matrix, '/industries/manufacturing-warehousing', '/industries/construction', '/demo'],
  [MODULE_PATHS.checklists]: ['/platform', MODULE_PATHS.actions, MODULE_PATHS.fleet, MODULE_PATHS.incidents, MODULE_PATHS.training, '/industries/transport-logistics', '/industries/manufacturing-warehousing', '/demo'],
  [MODULE_PATHS.contractors]: ['/platform', MODULE_PATHS.permits, MODULE_PATHS.actions, MODULE_PATHS.documents, MODULE_PATHS.training, '/industries/construction', '/industries/facilities-management', '/demo'],
