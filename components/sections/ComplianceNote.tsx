    ...
    <section className="bg-[#0a0a0a] border-y border-white/10">
      <div className="mx-auto max-w-5xl px-6 py-8 md:py-10">
        <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6">
          <div className="shrink-0 w-10 h-10 rounded-full bg-[#e5342a]/10 border border-[#e5342a]/30 flex items-center justify-center">
            <ShieldAlert className="size-5 text-[#e5342a]" strokeWidth={1.75} />
          </div>
          <p className="text-sm md:text-base text-white/80 leading-relaxed">
            <span className="font-bold text-white">Compliance risk —</span>{' '}
            A single HSE enforcement notice can cost{' '}
            <span className="font-bold text-[#e5342a]">£10,000+</span>.
