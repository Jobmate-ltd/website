...
// (Workstream D). Phase 2 renders components/about/about-platform.tsx instead
// when the launch flag is on; this file is what production shows until then.
//
