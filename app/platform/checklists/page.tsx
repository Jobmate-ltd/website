...
/**
 * Gated on PHASE_3_INPUTS.checklistBuilderShipped (lib/brand.ts): 404, out of the menu and the
...
export const metadata: Metadata = buildMetadata('/platform/checklists')

export default function Page() {
  return <ModulePageTemplate id="checklists" />
}
