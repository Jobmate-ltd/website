...
import { transportLogistics } from '@/lib/industries/transport-logistics'
 ...
 * Phase 3 industry page renders from lib/industries/transport-logistics.ts with the
 * launch row of the keyword map.
 */
export const metadata: Metadata = PLATFORM_LAUNCH ? buildMetadata('/industries/transport-logistics') : phase1Metadata

export default function TransportLogisticsPage() {
  return PLATFORM_LAUNCH ? <IndustryPageTemplate content={transportLogistics} /> : <IndustryPage content={phase1} />
}
