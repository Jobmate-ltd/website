// The Phase 1 page for window-door-fitters, kept verbatim: with NEXT_PUBLIC_PLATFORM_LAUNCH
// off, production renders exactly this. page.tsx switches to the Phase 3
// template (lib/industries/window-door-fitters.ts) when the flag is on.
